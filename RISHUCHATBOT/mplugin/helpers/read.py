...
╔═══⋆ʟᴏᴠᴇ ᴡɪᴛʜ⋆═══╗
♡ [ɢx ᴅᴀʀᴋ ʙᴏᴛs [🇮🇳]](https://t.me/dark_x_knight_musiczz_support) ♡
╚═════ ⋆★⋆ ═════╝
...
HELP_READ = f"""**
Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  Iғ ʏᴏᴜ'ʀᴇ ғᴀᴄɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ɪɴ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ](https://t.me/dark_knight_support).
